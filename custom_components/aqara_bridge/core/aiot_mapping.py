...
AIOT_DEVICE_MAPPING = [
        ...
        'params': [
            {
                "remote": {
                    MK_INIT_PARAMS: {
                        MK_HASS_NAME: "soundtrigger",
                    },
                    MK_RESOURCES: {
                        "soundtrigger": ("3.22.85", "_attr_is_on"),
                    }
                }
            }
        ]
    ...
    , {
        ...
        'params': [
            {
                "climate": {
                    MK_INIT_PARAMS: {
                        ...
                        "supported_features": ClimateEntityFeature.TARGET_TEMPERATURE | ClimateEntityFeature.FAN_MODE | ClimateEntityFeature.TURN_ON | ClimateEntityFeature.TURN_OFF,
        ...
        'lumi.curtain.v1': ["Aqara", "Curtain ZigBee", "ZNCLDJ12LM"],
        # Aqara智能窗帘电机（锂电池开合帘版）
        'lumi.curtain.hagl04': ["Aqara", "Curtain B1", "ZNCLDJ11LM"],
        'params': [
            {
                "cover": {
                    MK_INIT_PARAMS: {
